...
SECRET_KEY = 'django-insecure-wz*gfjgb#=5o&r1-6&7_#m+g@eabj^h&rvm8c90kvj-0$z%e-p'
...
STATIC_ROOT = BASE_DIR / 'static_collected' # This was added and fixed the MIME css error
